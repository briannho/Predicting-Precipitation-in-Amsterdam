##this was used to calculate the mean accuracies of the nonhomogeneous HMM

##Nonhomogeneous Hidden Markov Model

simulated <- read.csv('/Users/BrianHo/Downloads/mvnhmm/stat337results/amsterdam_nhmm_sim', sep=' ', header=FALSE)
